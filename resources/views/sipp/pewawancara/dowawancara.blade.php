        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <ul class="nav nav-tabs">
              <li class="active tablinks"><a data-toggle="tab" onclick="openCity(event, 'PenilaianWawancara')" id="defaultOpen">Penilaian Wawancara</a></li>
              <li class="tablinks"><a data-toggle="tab" onclick="openCity(event, 'Biodata')">Biodata</a></li>
            ...
            {{-- <div class="tab-content"> --}}
              <div id="PenilaianWawancara" class="tabcontent">
                <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    <div class="tab-pane fade in active" id="wawancara">
                      {!! Form::open(['route' => 'dowawancara.store', 'files'=>true, 'enctype'=>'multipart/form-data']) !!}
                        <h4 class="hform"><b>Penilaian Wawancara</b></h4>
                        <br>
                        <h5 class="hform"><b>Pewawancara</b></h5>
                        <p>Pewawancara 1</p>
                        <input class="form-control" type="text" name="pewawancara1" value="Dra. Woelan Handadari, M.Si., Psikolog" readonly>
                        <input type="hidden" name="idpewawancara1" value="68">
                        <br>

                        <p>Pewawancara 2</p>
                        <input class="form-control" type="text" name="pewawancara2" value="Dr. Duta Nurdibyanandaru, MS., Psikolog" readonly>
                        <input type="hidden" name="idpewawancara2" value="83">

                        <br> <br>


                        <h5 class="hform"><b>Keterampilan</b></h5>
                        <table class="table table-bordered">
                          <thead>
                            <tr>
                              <th><center>No</th>
                              <th><center>Aspek Psikodiagnostika</th>
                              <th><center>Buruk</th>
                              <th><center>Cukup</th>
                              <th><center>Baik</th>
                            </tr>
                          ...
                          <tbody>
                            <tr>
                              <th style="vertical-align: middle;" scope="row"><center>1</th>
                              <td style="vertical-align: middle;">Ketepatan pemilihan asesmen</td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan1" value="1"> --}}
                                {{ Form::radio('keterampilan1', '1') }}
                              </td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan1" value="2"> --}}
                                {{ Form::radio('keterampilan1', '2') }}
                              </td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan1" value="3"> --}}
                                {{ Form::radio('keterampilan1', '3') }}
                              </td>
                            </tr>
                            <tr>
                              <th style="vertical-align: middle;" scope="row"><center>2</th>
                              <td style="vertical-align: middle;">Administrasi dan skoring</td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan2" value="1"> --}}
                                {{ Form::radio('keterampilan2', '1') }}
                              </td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan2" value="2"> --}}
                                {{ Form::radio('keterampilan2', '2') }}
                              </td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan2" value="3"> --}}
                                {{ Form::radio('keterampilan2', '3') }}
                              </td> 
                            </tr>
                            <tr>
                              <th style="vertical-align: middle;" scope="row"><center>3</th>
                              <td style="vertical-align: middle;">Interpretasi</td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan3" value="1"> --}}
                                {{ Form::radio('keterampilan3', '1') }}
                              </td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan3" value="2"> --}}
                                {{ Form::radio('keterampilan3', '2') }}
                              </td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan3" value="3"> --}}
                                {{ Form::radio('keterampilan3', '3') }}
                              </td> 
                            </tr>
                            <tr>
                              <th style="vertical-align: middle;" scope="row"><center>4</th>
                              <td style="vertical-align: middle;">Penanganan : Intervensi (konseling, psikoterapi, dll)</td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan4" value="1"> --}}
                                {{ Form::radio('keterampilan4', '1') }}
                              </td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan4" value="2"> --}}
                                {{ Form::radio('keterampilan4', '2') }}
                              </td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan4" value="3"> --}}
                                {{ Form::radio('keterampilan4', '3') }}
                              </td>  
                            </tr>
                            <tr>
                              <th style="vertical-align: middle;" scope="row"><center>5</th>
                              <td style="vertical-align: middle;">Rekomendasi</td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan5" value="1"> --}}
                                {{ Form::radio('keterampilan5', '1') }}
                              </td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan5" value="2"> --}}
                                {{ Form::radio('keterampilan5', '2') }}
                              </td>
                              <td style="vertical-align: middle;"><center>
                                {{-- <input type="radio" class="w3-radio" name="keterampilan5" value="3"> --}}
                                {{ Form::radio('keterampilan5', '3') }}
                              </td> 
                            </tr>
                          </tbody>
                        </table>

                        <h5 class="hform">Etika</h5>
                        <table class="table table-bordered">
                          <thead>
                          <tr>
                          <th><center>No</th>
                          <th><center>Etika</th>
                          <th><center>Kemampuan</th>
                          </tr>
                          </thead>
                          <tbody>
                            <tr>
                              <th style="vertical-align: middle;" scope="row"><center>1</th>
                              <td style="vertical-align: middle;">Pengetahuan dasar</td>
                              <td style="vertical-align: middle;">
                                <div class="form-group">
                                  <div><center>
                                    <label>
                                      {{-- <input type="radio" class="w3-radio" name="etika1" value="1">&nbsp;&nbsp;Buruk --}}
                                      {{ Form::radio('etika1', '1') }}&nbsp;&nbsp;Buruk
                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label>
                                      {{-- <input type="radio" class="w3-radio" name="etika1" value="2">&nbsp;&nbsp;Cukup --}}
                                      {{ Form::radio('etika1', '2') }}&nbsp;&nbsp;Cukup
                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label>
                                      {{-- <input type="radio" class="w3-radio" name="etika1" value="3">&nbsp;&nbsp;Baik  --}}
                                      {{ Form::radio('etika1', '3') }}&nbsp;&nbsp;Baik
                                    </label>
                                  </div>
                                </div>
                              </td>   
                            ...
                            <tr>
                              <th style="vertical-align: middle;" scope="row"><center>2</th>
                              <td style="vertical-align: middle;">Penerapan dalam praktik profesi</td>
                              <td style="vertical-align: middle;">
                                <div class="form-group">
                                  <div><center>
                                    <label>
                                      {{-- <input type="radio" class="w3-radio" name="etika2" value="1">&nbsp;&nbsp;Buruk --}}
                                      {{ Form::radio('etika2', '1') }}&nbsp;&nbsp;Buruk
                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label>
                                      {{-- <input type="radio" class="w3-radio" name="etika2" value="2">&nbsp;&nbsp;Cukup --}}
                                      {{ Form::radio('etika2', '2') }}&nbsp;&nbsp;Cukup
                                    </label>
                                    <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      {{-- <input type="radio" class="w3-radio" name="etika2" value="3">&nbsp;&nbsp;Baik  --}}
                                      {{ Form::radio('etika2', '3') }}&nbsp;&nbsp;Baik
                                    </label>
                                  </div>
                                </div>
                              </td>   
                            ...
                            <tr>
                              <th style="vertical-align: middle;" scope="row"><center>3</th>
                              <td style="vertical-align: middle;">Kepemilikan Buku Kode Etik Psikologi Indonesia edisi Juni 2010</td>
                              <td style="vertical-align: middle;">
                                <div class="form-group">
                                  <div><center>
                                    <label>
                                      {{-- <input type="radio" class="w3-radio" name="etika3" value="0">&nbsp;&nbsp;Tidak --}}
                                      {{ Form::radio('etika3', '0') }}&nbsp;&nbsp;Tidak
                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label>
                                      {{-- <input type="radio" class="w3-radio" name="etika3" value="1">&nbsp;&nbsp;Ya --}}
                                      {{ Form::radio('etika3', '1') }}&nbsp;&nbsp;Ya
                                    </label>
                                  </div>
                                </div>
                              </td>  
                        ...
                        <h5 class="hform"><b>Kelebihan</b></h5>
                        <p>   </p>
                        {{-- <textarea id="editor1" name="kelebihan" class="textarea-table"></textarea> --}}
                        {{ Form::textarea('kelebihan', null, array('class' => 'textarea-table', 'style' => 'width:100%')) }}

                        <h5 class="hform"><b>Kekurangan</b></h5>
                        <p>   </p>
                        {{-- <textarea id="editor2" name="kekurangan"  class="textarea-table"> </textarea> --}}
                        {{ Form::textarea('kekurangan', null, array('class' => 'textarea-table', 'style' => 'width:100%')) }}

                        <h5 class="hform"><b>Rekomendasi</b></h5>
                        <p>   </p>
                        {{-- <select class="form-control" name="feedback">
                          <option value="7">Pengajuan Keanggotaan SIPP DIREKOMENDASIKAN</option>
                          <option value="12">Pengajuan Keanggotaan SIPP TIDAK DIREKOMENDASIKAN (Mengulang Wawancara)</option>
                          <option value="8">Pengajuan Keanggotaan SIPP DIREKOMENDASIKAN dengan Perbaikan</option>
                        </select> --}}
                        {{ Form::select('feedback', ['7' => 'Pengajuan Keanggotaan SIPP DIREKOMENDASIKAN', '12' => 'Pengajuan Keanggotaan SIPP TIDAK DIREKOMENDASIKAN (Mengulang Wawancara)', '8' => 'Pengajuan Keanggotaan SIPP DIREKOMENDASIKAN dengan Perbaikan'], null, array('class' => 'form-control')) }}
                        <br><br>
                        <hr>
                        <br><br>
                        <div class="box-footer">
                          {{-- <center><button type="submit" class="btn btn-primary btn-block btn-lg" data-toggle="modal" data-target=".bs-example-modal-lg">Beri Penilaian</button></center> --}}
                          <center>{{ Form::submit('Beri Penilaian', array('class' => 'btn btn-primary btn-block btn-lg')) }}</center>
                        </div>
                      {!! Form::close() !!}
                    </div>
                </div>
