                  ...
                  <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        {{ Form::text('email', $value = Auth::user()->email, array('class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'purwandari@gmail.com', 'required' => '')) }}
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        {{ Form::text('nama_lengkap', $value = Auth::user()->name, array('class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Purwandari, M.Si.', 'required' => '')) }}
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        {{ Form::file('foto_pas', null, array('class' => 'form-control', 'required' => '')) }}
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        {{-- <input name="pasfoto" id="foto" type="file" class="file" required> --}}
                        {{ Form::file('foto_ktp', null, array('class' => 'form-control', 'required' => '')) }}
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        {{-- <input name="pasfoto" id="foto" type="file" class="file" required> --}}
                        {{ Form::file('foto_kta', null, array('class' => 'form-control', 'required' => '')) }}
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        {{ Form::file('sertifikat_sebutan', null, array('class' => 'form-control', 'required' => '')) }}
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        {{ Form::file('surat_izin', null, array('class' => 'form-control', 'required' => '')) }}
                      </div>
                    </div>
